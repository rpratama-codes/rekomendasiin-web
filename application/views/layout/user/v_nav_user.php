    <!-- Navbar -->
    <nav class="main-header font-weight-bold navbar navbar-expand-md navbar-red navbar-info">
      <div class="container">
        <a href="<?= site_url() ?>" class="navbar-brand">
          <img src="<?= site_url('img/logo.svg') ?>" class="brand-image " style="opacity: 8">
            ...
            <div class="dropdown-menu dropdown-menu-xs dropdown-menu-right ">
              <?php if (empty($keranjang)) { ?>
                ...
                <div class=" text-sm-center">
                  <a href="<?= base_url('belanja') ?>" class=" text-center btn btn-sm btn-primary ">View Cart</a>
                </div>
                <br>
              <?php } ?>
