    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?= base_url('barang/addbarang') ?>" type=" button" class="btn btn-primary btn_sm"><i class="fas fa-plus"></i>Add
                </a>
            </div>
            <!-- /.card-tools -->
        </div>
                ...
                <tbody class="text-center">
                    ...
                    foreach ($barang as $key => $value) { ?>
                        <tr>
                            ...
                            <td><img src="<?= base_url('gambar/' . $value->gambar) ?>" width="50px" class="img-responsive"></td>
                            <td>
                                <a href="<?= base_url('barang/edit/' . $value->id_barang) ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                <button data-toggle="modal" data-target="#delete<?= $value->id_barang ?>" class="btn btn-danger btn-sm">
