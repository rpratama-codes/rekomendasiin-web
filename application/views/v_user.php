                    ...
                    foreach ($user as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?php
                                ...
                                ?></td>
                            <td>
                                <button data-toggle="modal" data-target="#edit<?= $value->id_user ?>" class="btn btn-warning btn-xs">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button data-toggle="modal" data-target="#delete<?= $value->id_user ?>" class="btn btn-danger btn-xs">
            ...
            <div class="modal-content bg-secondary">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Akses</label>
                        <select name="rule_id" class="form-control">
                            <option value="1" <?php if ($value->rule_id == 1) {
                                                    echo 'selected';
                                                } ?>>Admin</option>
                            <option value="2" <?php if ($value->rule_id == 2) {
                                                    echo 'selected';
                                                } ?>>User</option>
                        </select>
                    </div>
